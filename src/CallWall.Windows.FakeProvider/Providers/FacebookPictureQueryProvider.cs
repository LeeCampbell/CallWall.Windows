                        ...
                        var snowSwim = new Album
                                           {
                                               ...
                                               Pictures =
                                                   {
                                                       new Picture{ Timestamp = DateTimeOffset.Now.AddDays(-3), Source= new Uri("pack://application:,,,/CallWall.Windows.FakeProvider;component/Images/Pictures/SnowSwim/a.jpg")},
                                                       new Picture{ Timestamp = DateTimeOffset.Now.AddDays(-3), Source= new Uri("pack://application:,,,/CallWall.Windows.FakeProvider;component/Images/Pictures/SnowSwim/b.jpg")},
                                                       new Picture{ Timestamp = DateTimeOffset.Now.AddDays(-3), Source= new Uri("pack://application:,,,/CallWall.Windows.FakeProvider;component/Images/Pictures/SnowSwim/c.jpg")},
                                                       new Picture{ Timestamp = DateTimeOffset.Now.AddDays(-3), Source= new Uri("pack://application:,,,/CallWall.Windows.FakeProvider;component/Images/Pictures/SnowSwim/d.jpg")},
                                                       new Picture{ Timestamp = DateTimeOffset.Now.AddDays(-3), Source= new Uri("pack://application:,,,/CallWall.Windows.FakeProvider;component/Images/Pictures/SnowSwim/e.jpg")},
                                                       new Picture{ Timestamp = DateTimeOffset.Now.AddDays(-3), Source= new Uri("pack://application:,,,/CallWall.Windows.FakeProvider;component/Images/Pictures/SnowSwim/f.jpg")},
                                                   }
                                           };
                        o.OnNext(snowSwim);
                        o.OnCompleted();
