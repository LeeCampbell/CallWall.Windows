...
namespace CallWall.Windows.Google.UnitTests.Providers
{
    public abstract class Given_a_constructed_GoogleContactQueryProvider
    {
        ...
        [TestFixture]
        public sealed class When_constructed : Given_a_constructed_GoogleContactQueryProvider
        {
            #region Setup
            ...
            {
                base.Setup();
                var authorizedResources = new HashSet<Uri>(new[] {GoogleResource.Contacts.Resource});
                _authorizationMock.SetupGet(a => a.Status)
                                  .Returns(Windows.Google.Authorization.AuthorizationStatus.Authorized(authorizedResources));
                ...
                _sut = new GoogleContactQueryProvider(_authorizationMock.Object, _httpClient, _translatorMock.Object,
                                                      _logFactoryStub.Object);
            }
            ...
            [Test]
            public void Should_call_webClient_without_a_search_query()
            {
                Assert.IsNullOrEmpty(_httpClient.Requests[0].QueryStringParameters["q"]);
            }
            [Test]
            public void Should_call_webClient_with_version_3_of_the_contract()
            {
        ...
        public sealed class When_loading_ContactProfile : Given_a_constructed_GoogleContactQueryProvider
        {
            ...
            public void Should_call_webClient_first_with_GoogleContactURI()
            {
                ...
                Assert.AreEqual(_contactsUri, _httpClient.Requests[1].EndPointUrl);
            }
            [Test]
            ...
            public void Should_call_webClient_first_with_Identifier_value()
            {
                ...
                Assert.AreEqual(_profile.Identifiers.Single().Value, _httpClient.Requests[1].QueryStringParameters["q"]);
            }
            [Test]
            ...
            public void Should_call_webClient_second_with_GoogleContactGroupUri()
            {
                ...
                Assert.AreEqual(_groupsUri, _httpClient.Requests[2].EndPointUrl);
            }
            [Test]
            public void Should_call_webClient_second_with_AccessToken()
            {
                ...
                Assert.AreEqual(_accessToken, _httpClient.Requests[2].QueryStringParameters["access_token"]);
            }
            [Test]
            public void Should_call_webClient_second_with_version_3_of_the_contract()
            {
                ...
                Assert.AreEqual("3.0", _httpClient.Requests[2].Headers["GData-Version"]);
            }
        ...
        private sealed class StubHttpClient : IHttpClient
        {
            ...
            public IObservable<string> GetResponse(HttpRequestParameters request)
            {
                ...
                string response = _responder(request);
