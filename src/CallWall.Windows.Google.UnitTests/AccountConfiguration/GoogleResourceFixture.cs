...
namespace CallWall.Windows.Google.UnitTests.AccountConfiguration
{
    ...
    public sealed class GoogleResourceFixture
    {
        ...
        public void Should_return_GoogleContact_values()
        {
            ...
            Assert.AreEqual(new Uri("pack://application:,,,/CallWall.Windows.Google;component/Images/Contacts_48x48.png"), GoogleResource.Contacts.Image);
        ...
        public void Should_return_Gmail_values()
        {
            ...
            Assert.AreEqual(new Uri("pack://application:,,,/CallWall.Windows.Google;component/Images/Email_48x48.png"), GoogleResource.Gmail.Image);
