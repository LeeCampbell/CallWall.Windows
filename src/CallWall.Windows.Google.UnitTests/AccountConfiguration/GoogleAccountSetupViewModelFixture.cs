...
namespace CallWall.Windows.Google.UnitTests.AccountConfiguration
{
    ...
    public sealed class GoogleAccountSetupViewModelFixture
    {
        ...
        public void SetUp()
        {
            ...
            _authorizationMock.SetupGet(a => a.Status).Returns(Windows.Google.Authorization.AuthorizationStatus.NotAuthorized);
        ...
        {
            _authorizationMock.SetupGet(m => m.Status).Returns(Windows.Google.Authorization.AuthorizationStatus.NotAuthorized);
